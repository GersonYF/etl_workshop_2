...
class Settings(BaseSettings):
    ...
    POSTGRES_DB: str = Field("airflow", env="POSTGRES_DB")
    ...
    POSTGRES_URI: Union[PostgresDsn, None] = Field(None, env="POSTGRES_URI")
    DATA_FILE: str = Field("the_grammy_awards.csv", env="DATA_FILE")
